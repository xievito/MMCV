...
def get_pretraining_set_intra_cmq(opts):

    from feeder.feeder_pretraining_intra import Feeder_quadruple
    training_data = Feeder_quadruple(**opts.train_feeder_args)
