...
if __name__ == '__main__':
    ...
    # parser.add_argument('--data_path', default='/data/user/dataset/NTU/nturgb+d_skeletons_60/')
    # parser.add_argument('--ignored_sample_path',
    #                     default='resource/NTU_RGBD60_samples_with_missing_skeletons.txt')
    # parser.add_argument('--out_folder', default='../data/NTU-RGB-D-60-AGCN/')
    # benchmark = ['xsub', 'xview']

    parser.add_argument('--data_path', default='G:\\data\\ntu120')
    parser.add_argument('--ignored_sample_path',
                       default='resource/NTU_RGBD120_samples_with_missing_skeletons.txt')
