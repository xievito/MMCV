...
from dataset import get_finetune_training_set_semi_supervised, get_finetune_validation_set_semi_supervised
...
def main_worker(gpu, ngpus_per_node, args):
    ...
    elif args.finetune_dataset== 'ntu60' and args.protocol == 'cross_view_semi':
        opts = options.opts_ntu_60_cross_view()
    elif args.finetune_dataset== 'ntu60' and args.protocol == 'cross_subject_semi':
        opts = options.opts_ntu_60_cross_subject()
    elif args.finetune_dataset== 'pku_v2' and args.protocol == 'cross_subject_semi':
        opts = options.opts_pku_v2_cross_subject()
    ...
    train_dataset = get_finetune_training_set_semi_supervised(opts)
    val_dataset = get_finetune_validation_set_semi_supervised(opts)
