...
class opts_pku_v1_cross_subject():
    ...
    def __init__(self):
        ...
        # feeder
        self.train_feeder_args = {
            'data_path': './data/PKU-MMD-v1-AGCN/xsub/train_data_joint.npy',
            'label_path': './data/PKU-MMD-v1-AGCN/xsub/train_label.pkl',
            'num_frame_path': './data/PKU-MMD-v1-AGCN/xsub/train_num_frame.npy',
            'l_ratio': [0.5, 1.0],
            'input_size': 64
        }
        ...
        self.test_feeder_args = {
            ...
            'data_path': './data/PKU-MMD-v1-AGCN/xsub/val_data_joint.npy',
            'label_path': './data/PKU-MMD-v1-AGCN/xsub/val_label.pkl',
            'num_frame_path': './data/PKU-MMD-v1-AGCN/xsub/val_num_frame.npy',
            'l_ratio': [0.95],
            'input_size': 64
        }
